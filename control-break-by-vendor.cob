...
PROGRAM-ID. print-all-vouchers-to-pay.
ENVIRONMENT DIVISION.
   INPUT-OUTPUT SECTION.
      FILE-CONTROL.
         ...
         SELECT PRINTER-FILE 
                ASSIGN TO "print-all-vouchers-to-pay.prn"
...
DATA DIVISION.
   ...
   WORKING-STORAGE SECTION.
         ...
         77 CURRENT-VENDOR-NUMBER                PIC 9(5).         
         77 CURRENT-VENDOR-TOTAL                 PIC S9(7)V99.
...
PROCEDURE DIVISION.
    ...
    SORT SORT-FILE
     ...
     ELSE
        ...
        PERFORM PRINT-ALL-VENDOR-VOUCHERS UNTIL END-OF-FILE
...
*>------------- Save breaking information -----------------------
   ...
   MOVE WORK-VENDOR TO CURRENT-VENDOR-NUMBER.

*>--------------------------------------------------------------

   PERFORM PRINT-A-RECORD UNTIL 
                               WORK-VENDOR NOT = CURRENT-VENDOR-NUMBER
                                                OR
                                           END-OF-FILE.

*>------------- Print Total -------------------
   MOVE "Total"              TO D-DESCRIPTION.
   MOVE CURRENT-VENDOR-TOTAL TO D-TOTAL.
...
PRINT-A-RECORD. 
       ...
       ADD WORK-AMOUNT TO CURRENT-VENDOR-TOTAL.
