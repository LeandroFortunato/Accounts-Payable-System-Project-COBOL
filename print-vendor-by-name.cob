...
PROGRAM-ID. print-vendor-by-name.
ENVIRONMENT DIVISION.
   INPUT-OUTPUT SECTION.
      FILE-CONTROL.

         SELECT PRINTER-FILE 
                ASSIGN TO "print-vendor-by-name.prn"
...
DATA DIVISION.
   ...
   WORKING-STORAGE SECTION.
         ...
         01 TITLE.
            ...
            05 FILLER              PIC X(27) VALUE "LIST OF ALL VENDORS BY NAME".
...
PROCEDURE DIVISION.
     ...
     PERFORM CHANGE-TO-VENDOR-NAME-KEY-PATH.   
...
CHANGE-TO-VENDOR-NAME-KEY-PATH. 

   MOVE SPACES TO VENDOR-NAME.

   START VENDOR-FILE
     KEY NOT < VENDOR-NAME
       INVALID KEY                    *> records not found. it means EOF.
